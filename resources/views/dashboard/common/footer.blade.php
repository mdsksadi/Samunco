<footer class="footer">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 pb-5 pb-lg-0">
                    <div class="widget">
                        ...
                        <img src="{{ asset('/public/dashboard-template/images/logo-footer.png') }}" alt="Logo" class="m-b-3">
    ...
    <div class="footer-bottom">
        <div class="container d-flex justify-content-between align-items-center flex-wrap">
            ...
            <img src="{{ asset('/public/dashboard-template/images/payments.png') }}" alt="payment methods" class="footer-payments py-3">
        </div>
    </div><!-- End .container -->
</footer>